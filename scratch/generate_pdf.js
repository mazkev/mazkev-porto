...
<div class="page">
  ...
  <div class="section">
    ...
    <div class="job">
      <div class="job-header">
        <div>
          <span class="job-title">Software Development (Independent Projects)</span> — <span class="job-company">Hands-on Practice & Open Source</span>
        </div>
  ...
  <div class="section">
    ...
    <div class="edu-row">
      <div>
        ...
        <div style="font-size: 7.5pt; color: #475569;">Universitas AMIKOM • GPA: 3.42 / 4.00</div>
      </div>
...
<div class="page">
  ...
  <div class="section">
    ...
    <div class="job">
      <div class="job-header">
        <div>
          <span class="job-title">Pengembangan Perangkat Lunak (Proyek Mandiri)</span> — <span class="job-company">Eksplorasi Praktis & Open Source</span>
        </div>
  ...
  <div class="section">
    ...
    <div class="edu-row">
      <div>
        ...
        <div style="font-size: 7.5pt; color: #475569;">Universitas AMIKOM • IPK: 3.42 / 4.00</div>
      </div>
      <span class="job-date">2017 - 2022</span>
    </div>
  </div>
...
<!-- PAGE 3: LAMPIRAN PORTOFOLIO PROYEK -->
<div class="page">
  <div class="header" style="border-bottom: 2px solid #0f172a; padding-bottom: 8px; margin-bottom: 12px;">
    <div style="text-align: left;">
      <div class="name" style="font-size: 15pt;">Kevin Eka Pratama <span style="font-size: 8pt; background: #0f172a; color: white; padding: 2px 6px; border-radius: 4px; vertical-align: middle;">PORTFOLIO SHOWCASE</span></div>
      <div class="title" style="font-size: 8pt; color: #334155;">Lampiran Portofolio Proyek & Studi Kasus Rekayasa Perangkat Lunak</div>
    </div>
    <div class="header-text">
