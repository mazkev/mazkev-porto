...
export const projects: ProjectData[] = [
  ...
  },
  {
    ...
    description: 'Core banking transaction engine built with Go and PostgreSQL. Implements account balance transfers, ledger verification, database migrations, and RESTful API endpoints.',
