...
export const projects: ProjectData[] = [
  ...
  {
    title: 'Fullstack Java Spring Boot & Vue Marketplace',
    description: 'A fullstack e-commerce marketplace built with Java Spring Boot backend, Spring Security, and Vue 3 frontend with reactive cart state management.',
    tech: ['Java', 'Spring Boot', 'Vue.js 3', 'PostgreSQL'],
    image: '/projects/marketinvent.png',
    live: 'https://github.com/mazkev/belajar-java-springboot',
    github: 'https://github.com/mazkev/belajar-java-springboot',
    category: 'Full Stack',
  },
  {
    title: 'Fullstack Go & React Marketplace',
    description: 'A high-performance fullstack marketplace built with Golang GORM backend microservices and React TypeScript frontend with real-time checkout.',
    tech: ['Golang', 'GORM', 'React', 'PostgreSQL'],
  ...
  {
    title: 'Fullstack Python & Angular Marketplace',
    description: 'A fullstack e-commerce solution using Python FastAPI REST backend paired with Angular RxJS frontend and relational database models.',
    tech: ['Python', 'FastAPI', 'Angular', 'PostgreSQL'],
    image: '/projects/marketx.png',
    live: 'https://github.com/mazkev/python',
    github: 'https://github.com/mazkev/python',
    category: 'Full Stack',
  },
  {
    title: 'Fullstack React & Express Marketplace',
    description: 'A fullstack marketplace application built with React, Node.js Express API server, JWT authentication, and MongoDB database schema.',
    tech: ['React', 'Express.js', 'Node.js', 'MongoDB'],
    image: '/projects/semarketplace.jpg',
    live: 'https://github.com/mazkev/marketplace-fullstack',
    github: 'https://github.com/mazkev/marketplace-fullstack',
    category: 'Full Stack',
  },
  {
    title: 'AI Document Translator App',
    description: 'An AI-powered document translation web application built with React JS, featuring live multilingual translation, file uploads, and formatting preservation.',
    tech: ['React', 'TypeScript', 'AI API', 'Tailwind CSS'],
    image: '/projects/nexus.png',
    live: 'https://github.com/mazkev/AI-document-translator',
    github: 'https://github.com/mazkev/AI-document-translator',
    category: 'Front End',
  },
  {
    title: 'AI Code Syntax Translator',
    description: 'An AI-driven code translation tool built with React JS that converts code snippets between programming languages with syntax highlighting.',
    tech: ['React', 'TypeScript', 'OpenAI API'],
    image: '/projects/cryptodash.png',
    live: 'https://github.com/mazkev/syntax-translator',
    github: 'https://github.com/mazkev/syntax-translator',
    category: 'Front End',
  },
  {
    title: 'AI Resume & CV Analyzer',
    description: 'An AI resume evaluation tool built with React JS that parses candidate CVs, generates ATS score breakdowns, and provides tailored improvements.',
    tech: ['React', 'TypeScript', 'Tailwind CSS'],
    image: '/projects/canvass.png',
    live: 'https://github.com/mazkev/resume-analyzer',
    github: 'https://github.com/mazkev/resume-analyzer',
    category: 'Front End',
  },
  {
    title: 'AI YouTube Creator Assistant',
    description: 'An AI-powered assistant for content creators built with React JS, featuring video script generators, title optimizer prompts, and tag analytics.',
    tech: ['React', 'TypeScript', 'YouTube API'],
    image: '/projects/maztube.png',
    live: 'https://github.com/mazkev/youtube-creator-assistant',
    github: 'https://github.com/mazkev/youtube-creator-assistant',
    category: 'Front End',
  },
  {
    title: 'Traveloka Mobile App Clone',
    description: 'A mobile travel booking application clone of Traveloka built with React Native Expo, featuring flight & hotel search grids and dynamic booking forms.',
  ...
  {
    title: 'TikTok Mobile App UI Clone',
    description: 'A mobile short-form video application UI clone of TikTok built with React Native Expo, featuring video feed swipe gestures and interactive action overlays.',
    tech: ['React Native', 'Expo', 'TypeScript'],
  ...
  {
    title: 'Grab Flutter Mobile UI Clone',
    description: 'A mobile ride-hailing and food delivery UI clone of Grab built with Flutter and Dart, featuring multi-service drawer navigation and map overlays.',
    tech: ['Flutter', 'Dart', 'Mobile UI'],
    image: '/projects/grab.png',
    live: 'https://github.com/mazkev/grab-clone-flutter',
    github: 'https://github.com/mazkev/grab-clone-flutter',
    category: 'Front End',
  },
  {
    title: 'Golang Clean Architecture Microservice',
    description: 'A Golang backend microservice demonstrating Clean Architecture principles, domain-driven design layers, dependency injection, and RESTful routing.',
    tech: ['Golang', 'Clean Architecture', 'REST API'],
    image: '/projects/nexus.png',
  ...
  {
    title: 'RealWorld Conduit Backend Engine',
    description: 'An enterprise Node.js (Express + Prisma ORM) backend service implementing the RealWorld API specification with JWT auth, CRUD endpoints, and SQL migrations.',
    tech: ['Node.js', 'Express', 'Prisma ORM', 'PostgreSQL'],
    image: '/projects/nexus.png',
    live: 'https://github.com/mazkev/realworld-conduit-backend',
    github: 'https://github.com/mazkev/realworld-conduit-backend',
    category: 'Back End',
  },
  {
    title: 'Belajar Golang Microservices',
    description: 'A Golang backend repository focused on concurrent microservice routines, HTTP REST endpoints, GORM database queries, and unit test structures.',
    tech: ['Golang', 'Goroutines', 'REST API'],
    image: '/projects/marketinvent.png',
    live: 'https://github.com/mazkev/belajar-go',
    github: 'https://github.com/mazkev/belajar-go',
    category: 'Back End',
  },
  {
    title: 'Node.js Express URL Shortener API',
    description: 'A lightweight Node.js Express microservice for short URL generation, hash redirect handling, link click analytics, and MongoDB document storage.',
    tech: ['Node.js', 'Express', 'MongoDB', 'REST API'],
    image: '/projects/nexus.png',
    live: 'https://github.com/mazkev/url-shortener-nodejs',
    github: 'https://github.com/mazkev/url-shortener-nodejs',
    category: 'Back End',
  },
  {
