...
const content = {
  en: {
    ...
    job2Date: '2025 - Present',
    job2Bullet1: 'Designed and deployed custom web apps and enterprise dashboards using Next.js, Vue 3, Angular, and React.',
    job2Bullet2: 'Engineered real-time WebSocket pipelines in Express, capable of broadcasting data in <30ms.',
  ...
  id: {
    ...
    job2Bullet2: 'Membangun pipeline WebSocket real-time pada Express dan Firebase dengan kecepatan data <30ms.',
