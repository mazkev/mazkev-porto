      ...
      <div className="container-max grid lg:grid-cols-2 gap-10 lg:gap-14 items-center px-6 relative z-10 no-print">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-slate-600 dark:text-slate-300 max-w-lg mb-6 leading-relaxed font-medium">
            Backend & Fullstack Developer with <strong>2+ years of professional experience in Application Support at PT PLN Icon+</strong>, transitioning into Software Development. Focused on modern React/TypeScript frontends and clean, modular Go backend services.
          </p>
